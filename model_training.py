...
def train_model(X_train: Union[pd.DataFrame, Any], y_train: Any, X_val: Union[pd.DataFrame, Any], y_val: Any, params: dict) -> BaggingClassifier:
    # Example parameters (adjust as needed)
    params = params or {'n_estimators': 100, 'max_depth': 10, 'random_state': 42}
    
    # Train the model
    model = BaggingClassifier(base_estimator=DecisionTreeClassifier(max_depth=params['max_depth']),
